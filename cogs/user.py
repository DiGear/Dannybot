...
class user(commands.Cog):
    ...
    async def info(self, ctx: commands.Context, member: discord.Member = None):
        ...
        embed_info = {
            ...
            "fields": [
                {"name": "Display name:", "value": f"{member.global_name}", "inline": False},
                ...
                {"name": "Account Creation Date:", "value": member.created_at.strftime(date_format), "inline": False},
                {"name": "Server Join Date:", "value": member.joined_at.strftime(date_format), "inline": False}
            ],
